...
$host = 'localhost';
$dbname = 'loan';
$db_username = 'root'; // Rename to avoid overwriting the username
$db_password = '';
...
$sql = "SELECT Amount, StartDate, EndDate, Status FROM loans 
WHERE 
CustomerID = ?  ";
...
while ($row = $result->fetch_assoc()) {
  ...
  if ($approved == "Approved") {
      ...
      for ($i = 0; $i <= $months_diff; $i++) {
          ...
          // Add the loan amounts to the arrays
          $loanAmounts[] = $i; // Months
...
// Convert loan data to JSON format
$loanData = [
    'x' => $loanAmounts,
    'y' => $loanAmountsWithInterest
];

$loanBalanceDataJson = json_encode($loanData);
?>
...
<body class="g-sidenav-show  bg-gray-100">  
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/loanform.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card z-index-2">
            <div class="card-body p-3">
              <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                <div class="chart">
                  <canvas id="test" class="chart-canvas" height="170"></canvas>
                </div>
              </div>
          ...
          <div class="card z-index-2">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold">One Year</span>
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
                ...
                <table id="user-table" class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Interest Rate</th>
  ...
  <script>
    ...
    if (localStorage.getItem('isLoggedIn') === 'true') {
        ...
        document.getElementById('dashboardContent').innerHTML = '<p>Welcome, ' + username + '!</p>';
        // You can add more content specific to the logged-in user here
    } else {
  ...
  function fetchAndPopulateData() {
    fetch('../queryLoan2.php')
      .then(response => response.json())
      .then(data => {
        const tableBody = document.getElementById('user-table-body');
        tableBody.innerHTML = ''; // Clear existing table data
        
        // Loop through each loan application data and create table rows
        data.forEach(rowData => {
          const row = document.createElement('tr');
          row.innerHTML = `
            <td class="text-center">${rowData.LoanID}</td>
            <td class="text-center">${rowData.LoanTypeID}</td>
            <td class="text-center">${rowData.Amount}</td>
            <td class="text-center">${rowData.InterestRate}</td>
            <td class="text-center">${rowData.StartDate}</td>
            <td class="text-center">${rowData.EndDate}</td>
 ...
 <script>
        ...
        var loanData = <?php echo $loanBalanceDataJson; ?>;
